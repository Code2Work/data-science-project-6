# Data Science Python Project 6 — Liste ve String İşlemleri
...
# Questions
* Senaryo:
    Yüzüklerin Efendisi evreninde bir görev (task) yönetim sistemi geliştiriyorsun.
    Liste işlemleri, string manipülasyonları ve temel Python fonksiyonlarını kullanarak görevleri yöneteceksin.
